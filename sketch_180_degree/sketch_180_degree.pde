...
void drawRadar() {
  ...
  arc(0,0,(width-width*0.687),(width-width*0.687),PI,TWO_PI);
   arc(0,0,(width-width*0.875),(width-width*0.875),PI,TWO_PI);
...
void drawLine() {
  ...
  stroke(30,250,60);
  translate(width/2,height-height*0.074); // moves the starting coordinats to new location
  line(0,0,(height-height*0.12)*cos(radians(iAngle)),-(height-height*0.12)*sin(radians(iAngle))); // draws the line acco0rding to the angle
  popMatrix();
}
void drawText() { // draws the texts on the screen
  ...
  text("5cm",width-width*0.4554,height-height*0.0833);
